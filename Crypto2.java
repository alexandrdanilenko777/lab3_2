...
class Verify{
	...
	System.out.println("Verify () " + timer);
...
class Cryptool{
    ...
    /*
    Generate (r, s)
    1. compute random k, where: 0 < k < p-1 and gcd(k, p-1) = 1
    2. Compute r: r=g^k(mod p)
    ...
    */
    ...
    long timer = -System.currentTimeMillis();
        ...
        timer += System.currentTimeMillis();
System.out.println("Gen (r,s) " + timer);
        
    }


    /*
    Extended Euclidean Algorithm (used as part of finding the modular inverse)
    */
